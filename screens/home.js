...
export default class Homescreen extends Component{
  ...
  getArticle=()=>{
    ...
    .then((response)=>{
      ...
      details["duaration"]=this.timeconvert(details.duration);
  ...
  timeconvert(num){
   ...
   likedArticle=()=>{
    ...
    .then((response)=>{
     ...
     notlikedArticle=()=>{
    const url="http://localhost:5000/notliked-Article"
    axios.post(url)
    .then((response)=>{
     this.getArticle()
    })
     didnotwatchArticle=()=>{
    const url="http://localhost:5000/didnotwatch-Article"
    axios.post(url)
    .then((response)=>{
     this.getArticle()
    })
...
render(){
  ...
  if(ArticleDetails.postal_link){
    const {postal_link,title,releasedate,duration,overview,rating}=ArticleDetails
  }
  return( 
